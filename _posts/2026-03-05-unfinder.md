...
- [UN (Unity-Native) Fast Object Finder SDK](#un-unity-native-fast-object-finder-sdk)
- [Table of Contents](#table-of-contents)
- [Core Features](#core-features)
    - [O(1) 이름 조회 경로](#o1-이름-조회-경로)
    - [쿼리 기반 타입/태그 필터링](#쿼리-기반-타입태그-필터링)
    - [저할당 런타임](#저할당-런타임)
    - [라이프사이클 안전 캐시 무결성](#라이프사이클-안전-캐시-무결성)
    - [빌드 타임 오토 베이킹](#빌드-타임-오토-베이킹)
...
- [Operational Notes](#operational-notes)
    - [메인 스레드 전용](#메인-스레드-전용)
    - [가변 인덱스 상태는 UN API 우선](#가변-인덱스-상태는-un-api-우선)
    - [Query 결과는 `using` 사용 권장](#query-결과는-using-사용-권장)
    - [메모리 트리밍 (선택)](#메모리-트리밍-선택)
- [Performance Comparison](#performance-comparison)
    - [Default Unity API](#default-unity-api)
    - [UNFinder SDK](#unfinder-sdk)
- [마치며](#마치며)
